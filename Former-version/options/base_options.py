...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--dataroot', type=str, default='./datasets/MR2CT_pelvi', help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        ...
        parser.add_argument('--gpu_ids', type=str, default='0,3', help='gpu ids: e.g. 0  0,1,2, 0,2. use -1 for CPU')


        # parser.add_argument('--name', type=str, default='pelvi_0-75epoch', help='name of the experiment. It decides where to store samples and models')
        parser.add_argument('--name', type=str, default='cycle_Lcc',
                            help='name of the experiment. It decides where to store samples and models')
        # parser.add_argument('--name', type=str, default='wholebody_25epoch',
        #                     help='name of the experiment. It decides where to store samples and models')
